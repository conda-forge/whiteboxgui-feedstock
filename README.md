...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/whiteboxgui-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11798&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/whiteboxgui-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `whiteboxgui` can be installed with:

```
conda install whiteboxgui
```

It is possible to list all of the versions of `whiteboxgui` available on your platform with:
